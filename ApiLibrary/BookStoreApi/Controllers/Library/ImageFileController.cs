...
namespace Models.Controllers.Library.Files
{
    ...
    {
        readonly IImageFileService _service ;

        public ImageFileController(IImageFileService service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public IHttpActionResult Post(List<ImageFileDto> list)
        {
            return Ok(_service.Insert(list));
        }

        [HttpPut]
        public IHttpActionResult Put(List<ImageFileDto> list)
        {
