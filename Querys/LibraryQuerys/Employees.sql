...
Constraint Fk_EmployeeRol_IdEmployee foreign key (IdEmployee) references Employee (IdPerson)
);
...
Constraint Fk_EmployeeImageFile_IdEmployee foreign key (IdEmployee) references Employee (IdPerson),
